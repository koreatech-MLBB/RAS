...
urlpatterns = [
  ...
  # path('<str:user_id>/running/info', RunningSaveView.as_view()),
  path('<str:user_id>/running/info/<int:running_id>', RunningInfoView.as_view()),
  ...
  path('get_next_audio/', get_next_audio, name='get_next_audio'),
  # NOTE: feedback
